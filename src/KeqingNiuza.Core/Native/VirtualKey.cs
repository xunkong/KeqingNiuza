...
namespace KeqingNiuza.Core.Native
{
    ...
    public enum VirtualKey : ushort
    {
        ...
        /// </summary>
        /// <remarks>For more information, see Remark in <see cref="KEYBDINPUT"/>, <see cref="SendInput(int, INPUT*, int)"/>, <see cref="Msg.WM_KEYDOWN"/>, and <see cref="Msg.WM_KEYUP"/></remarks>
        VK_PACKET = 0xE7,
